...
- An enrolled user has to authenticate on the GroupID portal using the authentication type he or she
  ...
  the[Authenticate Your Identity Store Account](/docs/directorymanager/11.0/portal/secondfactorauthentication/authenticateaccount.md)
  topic.
...
:::note
The SMS authentication type is available if the GroupID administrator has linked an SMS
