...
5. On the
   [Selected Fields for object types](/docs/directorymanager/11.0/portal/synchronize/create/selectedfield.md)
...
6. Use the **Map Field** section to map the source and destination fields and to apply
   transformations:
    ...
    1. In the **Key** column, select at least one field to be a unique identifier.
        ...
        - [Map Fields](/docs/directorymanager/11.0/portal/synchronize/create/mappingfield.md)
