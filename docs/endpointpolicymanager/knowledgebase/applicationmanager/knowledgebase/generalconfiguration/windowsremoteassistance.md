...
- [Deploy any script via the Cloud to domain joined and non-domain joined machines](/docs/endpointpolicymanager/scriptstriggers/videolearningcenter/gettingstarted/cloud.md)
