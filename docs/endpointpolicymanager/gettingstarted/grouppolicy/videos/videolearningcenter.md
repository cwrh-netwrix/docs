...
- [Manual editing Item Level Targeting to affect local Admins and other local accounts](/docs/endpointpolicymanager/gettingstarted/grouppolicy/videos/tipsandtricks/editmanual.md)
...
- [Expand Modular View of Endpoint Policy Manager Components in the GPMC back to the Flat Legacy View](/docs/endpointpolicymanager/gettingstarted/grouppolicy/videos/tipsandtricks/flatlegacyview.md)
- [Trim the MMC console for OU admins](/docs/endpointpolicymanager/gettingstarted/grouppolicy/videos/tipsandtricks/mmcconsole.md)
- [Prevent a Remote Desktop Connection Drop During GP Update](/docs/endpointpolicymanager/gettingstarted/grouppolicy/videos/tipsandtricks/remotedesktopconnection.md)
