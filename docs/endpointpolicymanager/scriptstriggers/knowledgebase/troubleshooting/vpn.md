...
- VPN used must be in the list of supported VPNs in the article below.
  ...
  [Which VPN Solutions are currently supported for use with Scripts Manager VPN Triggers?](/docs/endpointpolicymanager/scriptstriggers/knowledgebase/troubleshooting/vpnsolutions.md)
