...
[Endpoint Policy ManagerScripts .. Deploy Software via VPN or with Endpoint Policy Manager Cloud](/docs/endpointpolicymanager/scriptstriggers/videolearningcenter/withcloud/cloud.md)
and
[Endpoint Policy Manager Scripts and YOUR MDM service: Un-real power](/docs/endpointpolicymanager/scriptstriggers/videolearningcenter/methods/mdm.md)
:::
