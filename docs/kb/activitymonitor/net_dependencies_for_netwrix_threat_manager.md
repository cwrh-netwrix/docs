...
ASP.NET Core 8.0.11 (or newer) and .NET Desktop Runtime 8.0.11 (or newer) are required. You can also navigate to the [Netwrix Threat Manager](/docs/threatmanager/3.0/index) landing page for the product **Requirements** located under **Getting Started**.
...
- [Netwrix Threat Manager](/docs/threatmanager/3.0/index)
