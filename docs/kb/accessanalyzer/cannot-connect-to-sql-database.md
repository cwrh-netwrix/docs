...
> **NOTE:** If you need to reset the AIC Administrator password, see: https://docs.netwrix.com/docs/accessanalyzer/resetting-the-aic-administrator-password
...
## Related Link
- Resetting the AIC Administrator Password: https://docs.netwrix.com/docs/accessanalyzer/resetting-the-aic-administrator-password
